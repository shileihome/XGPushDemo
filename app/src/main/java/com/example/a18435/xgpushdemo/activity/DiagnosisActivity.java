...
import com.example.a18435.xgpushdemo.bean.ClickAction;
import com.example.a18435.xgpushdemo.bean.Style;
import com.example.a18435.xgpushdemo.bean.TimeInterval;
import com.example.a18435.xgpushdemo.common.CommonWorkingThread;
import com.example.a18435.xgpushdemo.common.ExtendedListView;
import com.example.a18435.xgpushdemo.common.XingeApp;
...
public class DiagnosisActivity extends Activity implements ExtendedListView.OnPositionChangedListener {
    ...
    private void step4() {
        ...
        local_msg.setMin("10");
        local_msg.setActivity("com.example.a18435.xgpushdemo.activity.SettingActivity");
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            com.example.a18435.xgpushdemo.bean.Message message = new com.example.a18435.xgpushdemo.bean.Message();
            message.setType(com.example.a18435.xgpushdemo.bean.Message.TYPE_NOTIFICATION);
